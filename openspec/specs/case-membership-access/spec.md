## Purpose
Define case-level membership management and incident access inheritance so users manage access at the case boundary instead of duplicating incident-level membership workflows.
